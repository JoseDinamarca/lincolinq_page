    ...
    <div class="container">
      <div class="row section-heading">
        <header class="col-lg-12 col-xxl-12">
          <h2 class="card-title card-title-heading center">
            Políticas de privacidad
          </h2>
        </header>
      </div>
      <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
          ...
          <p class="parrafopolitica">
            Dev&Pro. ("nosotros", "nuestro" o "nos") se compromete a proteger su
            privacidad. Esta Política de privacidad explica cómo Dev&Pro.
          ...
          <ul>
            <li class="parrafopolitica">
              <strong>Cookie:</strong> pequeña cantidad de datos generados por
              un sitio web y guardados por su navegador web. Se utiliza para
            ...
            <li class="parrafopolitica">
              ...
              esta Política de privacidad. Plataforma: sitio web de Internet,
              aplicación web o aplicación digital de cara al público de Dev&Pro.
            </li>
            <li class="parrafopolitica">
            ...
            <li class="parrafopolitica">
              ...
              persona que se registra para utilizar el Servicio Dev&Pro para
              gestionar las relaciones con sus consumidores o usuarios del
              servicio.
            </li>
            <li class="parrafopolitica">
            ...
            <li class="parrafopolitica">
              <strong>Dirección IP:</strong> a cada dispositivo conectado a
              Internet se le asigna un número conocido como dirección de
              protocolo de Internet (IP). Estos números generalmente se asignan
              en bloques geográficos. A menudo, se puede utilizar una dirección
              IP para identificar la ubicación desde la que un dispositivo se
              conecta a Internet.
            </li>
            <li class="parrafopolitica">
              <strong>Personal:</strong> se refiere a aquellas personas que son
              empleadas por Dev&Pro o están bajo contrato para realizar un
              servicio en nombre de una de las partes.
            </li>
            <li class="parrafopolitica">
              <strong>Datos personales: </strong> cualquier información que
              directa, indirectamente o en conexión con otra información,
              incluido un número de identificación personal, permita la
            ...
            <li class="parrafopolitica">
              <strong>Terceros:</strong> se refiere a anunciantes,
              patrocinadores de concursos, socios promocionales y de marketing,
              y otros que brindan nuestro contenido o cuyos productos o
              servicios que creemos que pueden interesarle.
            </li>
            <li class="parrafopolitica">
          ...
          <br />
          <h5><strong>¿Qué información recopilamos?</strong></h5>
          <p class="parrafopolitica">
          ...
          <br />
          <h5><strong>¿Cómo usamos la información que recopilamos?</strong></h5>
          <p class="parrafopolitica">
          ...
          <ul>
            ...
            <li class="parrafopolitica">Para procesar transacciones</li>
            <li class="parrafopolitica">
          ...
          <h5>
            <strong
              >¿Cuándo usa Dev&Pro la información del cliente de
              terceros?</strong
            >
          </h5>
          <p class="parrafopolitica">
            ...
            para mostrar interés en convertirse en cliente de Dev&Pro, recibimos
            información de un tercero que brinda servicios automáticos de
            detección de fraude a Dev&Pro. Ocasionalmente, también recopilamos
          ...
          <h5>
            <strong
              >¿Compartimos la información que recopilamos con terceros?</strong
            >
          </h5>
          <p class="parrafopolitica">
          ...
          <h5>
            <strong>
              ...
              usuarios finales?</strong
            >
          </h5>
          <p class="parrafopolitica">
            Dev&Pro recopilará la información personal que nos envíe. También
            podemos recibir información personal sobre usted de terceros como se
            describe anteriormente.
          </p>
          <br />
          <h5>
            <strong>¿Podría transferirse mi información a otros países?</strong>
          </h5>
          <p class="parrafopolitica">
            Estamos incorporados en Chile. La información recopilada a través de
          ...
          <h5>
            <strong>
              ¿La información recopilada a través del Servicio Dev&Pro es
              segura?</strong
            >
          </h5>
          <p class="parrafopolitica">
          ...
          <br />
          <h5><strong>¿Puedo actualizar o corregir mi información?</strong></h5>
          <p class="parrafopolitica">
            Los derechos que tienes para solicitar actualizaciones o
            correcciones de la información que recopila Dev&Pro dependen de tu
            relación con Dev&Pro. El personal puede actualizar o corregir su
          ...
          <p class="parrafopolitica">
            ...
            sistema (sujeto al siguiente párrafo). Dichas actualizaciones,
            correcciones, cambios y eliminaciones no tendrán ningún efecto sobre
            otra información que mantenemos o información que hayamos
            proporcionado a terceros de acuerdo con esta Política de privacidad
            antes de dicha actualización, corrección, cambio o eliminación. Para
            proteger su privacidad y seguridad, podemos tomar medidas razonables
            (como solicitar una contraseña única) para verificar su identidad
            antes de otorgarle acceso a su perfil o hacer correcciones. Usted es
            responsable de mantener en secreto su información personal en todo
            momento.
          </p>
          <p class="parrafopolitica">
          ...
          <p class="parrafopolitica">
            Si es un trabajador o solicitante de Dev&Pro, recopilamos la
          ...
          <br />
          <h5><strong>Venta de Negocio</strong></h5>
          <p class="parrafopolitica">
            ...
            sustancialmente todos los activos de Dev&Pro o cualquiera de sus
            afiliadas corporativas (como se define en este documento), o la
            porción de Dev&Pro o cualquiera de sus Afiliadas corporativas con
          ...
          <p class="parrafopolitica">
            ...
            está controlada por o está bajo control común con Dev&Pro, ya sea
            por propiedad o de otra manera. Cualquier información relacionada
            con usted que proporcionemos a nuestros afiliados corporativos será
            tratada por dichos afiliados corporativos de acuerdo con los
            términos de esta política de privacidad.
          </p>
          <br />
          <h5><strong>¿Cuánto tiempo conservamos su información?</strong></h5>
          <p class="parrafopolitica">
            Conservamos su información solo mientras la necesitemos para
            proporcionarle Dev&Pro y cumplir con los propósitos descritos en
          ...
          <br />
          <h5><strong>¿Cómo protegemos su información?</strong></h5>
          <p class="parrafopolitica">
            ...
            información que transmita a Dev&Pro ni garantizar que su información
          ...
          <br />
          <h5><strong>Ley que Rige</strong></h5>
          <p class="parrafopolitica">
            Esta Política de privacidad se rige por las leyes de Chile sin tener
          ...
          <p class="parrafopolitica">
            ...
            sitio y cómo se utiliza. Al utilizar nuestra plataforma o contratar
            un servicio, por la presente acepta nuestra Política de privacidad y
            acepta sus términos.
          </p>
          <br />
          ...
          <p class="parrafopolitica">
            Dev&Pro utiliza "cookies" para identificar las áreas de nuestro
          ...
          <br />
          <h5><strong>Servicios de Remarketing</strong></h5>
          <p class="parrafopolitica">
          ...
          <br />
          <h5><strong>Privacidad de los Niños</strong></h5>
          <p class="parrafopolitica">
            No nos dirigimos a ninguna persona menor de 18 años. No recopilamos
            información de identificación personal de ninguna persona menor de
            18 años. Si usted es padre o tutor y sabe que su hijo nos ha
            ...
            menor de 18 años sin la verificación del consentimiento de los
            padres, tomamos medidas para eliminar esa información de nuestros
            servidores
          </p>
          <br />
          <h5><strong>Cambios en nuestra Política de Privacidad</strong></h5>
          <p class="parrafopolitica">
            ...
            actualizada, puede solicitar la eliminación de sus Datos personales
          ...
          <p class="parrafopolitica">
            ...
            Dev&Pro no asume ni tendrá ninguna obligación o responsabilidad ante
