    ...
    <div class="container mb-5 mb-md-6 mb-xl-10 ">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 text-center">
          <h2 class="card-title card-title-heading center ">Servicios</h2>
          <p class="service-p" >Ayudamos a las empresas a transformar su negocio y su tecnología</p>
        </div>
      </div>
    </div>
    <div class="row row-service">
      <div class="col-12 col-sm-6 col-xl-4 column">
        <div class="card-service">
          <div class="icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-mouse"
              viewBox="0 0 16 17">
              <path
          ...
          <p class="service-p">
            Lorem ipsum dolor sit cuchuflí barquillo bacán jote gamba listeilor po cahuín, luca melón con vino.
          </p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-xl-4 column">
        <div class="card-service">
          <div class="icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-chat-text "
              viewBox="0 0 15 17">
              <path
      ...
      <div class="col-12 col-sm-6 col-xl-4 column">
        <div class="card-service">
          <div class="icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-heart-pulse  "
              viewBox="0 -1 16 17">
